    ...
    <div className='max-w-screen-2xl container mx-auto x1:px-24  px-4 md:py-20 py-14'>
      ...
      <form>
        <div className='flex justify-start md:flex-row flex-col md:gap-0 gap-4'>
          ...
          {/* <div className='flex md:rounded-s-none rounded shadow-sm ring-1 ring-insert d-none ring-gray focus-within:ring-2 focus-within:ring-inset focus-within:ring-secondary md:w-1/3 w-full'>
            <input type="text" name='title' id="location" placeholder="" className='block flex-1 border-0 bg-transparent py-1.5 pl-8 text-gray placeholder:text-gray focus:right-0 sm:text-sm sm:leading-6' />
